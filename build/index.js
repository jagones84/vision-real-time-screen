...
class ProcessManagerServer {
    ...
    constructor() {
        ...
        this.server.onerror = (error) => console.error('[MCP Error]', error); // Add Error type
    ...
    handleStartProcess(args) {
        ...
        try {
            ...
            const commandArgs = parts.slice(1).map((arg) => arg.replace(/^["']|["']$/g, '')); // Add string type to arg
